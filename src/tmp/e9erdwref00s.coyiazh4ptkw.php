<div class="project-page">
    <div class="project-header">
        <?php if (isset($project['cover_image']) && $project['cover_image']): ?>
            <div class="project-cover">
                <img src="<?= ($base) ?>/project/<?= ($project['id']) ?>/cover" alt="Couverture">
            </div>
        <?php endif; ?>
        <div class="project-header__content">
            <div class="project-title-row">
                ...
                <div class="project-actions">
                    ...
                    <a class="button" href="<?= ($base) ?>/project/<?= ($project['id']) ?>/lecture">Mode Lecture</a>
                    ...
                    <?php foreach (($acts?:[]) as $act): ?>
                        <details class="act-container" id="act-<?= ($act['id']) ?>" data-persist="true">
                            <summary class="act-summary">
                                <h4>
                                    <input type="checkbox" class="export-toggle" data-type="act" data-id="<?= ($act['id']) ?>"
