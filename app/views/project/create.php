<?php
/* Project creation form. Variables: $errors (array), $old (array) */
?>
...
<?php endif; ?>
<form method="post" action="<?php echo $base; ?>/project/create">
    ...
    <div class="form-group" style="display: flex; gap: 20px;">
        <div style="flex: 1;">
            ...
            <input type="number" id="words_per_page" name="words_per_page"
                value="<?php echo $old['words_per_page'] ?? 350; ?>" min="1">
        </div>
        <div style="flex: 1;">
            <label for="target_pages">Nombre de pages total</label>
            <input type="number" id="target_pages" name="target_pages" value="<?php echo $old['target_pages'] ?? 0; ?>"
                min="0">
        </div>
    </div>
    <div class="form-group">
        <label for="target_words">Objectif de mots total</label>
        <input type="number" id="target_words" name="target_words" value="<?php echo $old['target_words'] ?? 0; ?>"
            min="0">
